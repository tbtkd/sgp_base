...
29. El top bar y sidebar 1.7.1 usan control local accesible; `logo.png` y `logo.ico` permanecen como recursos canónicos sin modificación.
...
42. Agenda de hoy, Próximas citas y Pacientes recientes permanecen sin cambios funcionales en 1.7.1; cualquier simplificación propuesta requiere una decisión posterior y pruebas de Dashboard.
