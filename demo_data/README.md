...
3. El comando crea cuentas de Administración, Medicina general, Odontología, Nutrición y Recepción; seis pacientes, historiales ampliados, nueve consultas, siete citas, dieciocho pagos operativos y una receta de tres medicamentos. Una consulta queda cerrada con una aclaración ficticia para validar el flujo 1.11.
...
La nota cerrada permite comprobar que Editar desaparece, que el cierre muestra responsable/fecha, que la aclaración se conserva y que ambos aparecen al imprimir. Otros historiales demo marcan asma, enfermedad hepática, trastornos neurológicos, cardiopatía, diabetes, hipertensión y dislipidemia.
