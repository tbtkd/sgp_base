...
## Dictamen funcional de la versión 1.6.1
...
| Elemento | Estado en 1.6.1 | Control operativo pendiente |
| --- | --- | --- |
...
| Firma | Línea para firma autógrafa | La impresión debe firmarse físicamente antes de entregarse |
...
- Se admiten hasta 10 medicamentos; se rechazan filas incompletas, manipuladas o exactamente duplicadas.
