...
29. El top bar y sidebar 1.7.4 usan control local accesible; `logo.png` y `logo.ico` permanecen como recursos canónicos y el favicon usa una URL versionada para invalidar caché obsoleta.
...
42. Agenda de hoy, Próximas citas y Pacientes recientes permanecen sin cambios funcionales en 1.7.4; cualquier simplificación propuesta requiere una decisión posterior y pruebas de Dashboard.
